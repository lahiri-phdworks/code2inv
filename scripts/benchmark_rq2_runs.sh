...
do
    ...
    -o results/inv_result_${var}_c_nl_spec.txt ${var} c_nl_spec) 2> RQ2_TIME_LOGS/z3_nl_time_$var.log
    ...
    -o results/inv_result_${var}_fuzz_spec.txt ${var} fuzz_spec) 2> RQ2_TIME_LOGS/fuzz_time_$var.log
