...
void precheck(FILE *file_descp, char *buff, long long int i, long long int x,
              long long int y, long long int z1, long long int z2,
              long long int z3) {
  int f = preflag;
...
void loopcheck(FILE *file_descp, char *buff, long long int temp_i,
               long long int temp_x, long long int temp_y, long long int i,
               long long int x, long long int y, long long int z1,
  ...
  if (f == 0 && loopflag == 1) {
    fprintf(file_descp,
            ...
            "%lld, %s : %lld\n",
            "i", temp_i, "x", temp_x, "y", temp_y, "z1", z1, "z2", z2, "z3",
            z3);
    fprintf(file_descp,
  ...
  for (;;) {
    ...
    if (choices > 10000) {
      ...
      if ((choices > 2500)) {
        ...
        if ((i < y)) {
          postcount++;
          postcheck(fptr, vars, (0 <= i), i, x, y, z1, z2, z3)
        }
      }
    }
