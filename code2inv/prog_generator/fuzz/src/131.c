...
void precheck(FILE *fptr, char *buff, long long int d1, long long int d2,
              long long int d3, long long int x1, long long int x2,
              long long int x3) {
  int f = preflag;
...
void loopcheck(FILE *fptr, char *buff, long long int temp_x1,
               long long int temp_x2, long long int temp_x3, long long int d1,
               long long int d2, long long int d3, long long int x1,
               long long int x2, long long int x3) {
  int f = loopflag;
  ...
  if (f == 0 && loopflag == 1) {
    fprintf(fptr,
            ...
            "%lld, %s : %lld\n",
            "d1", d1, "d2", d2, "d3", d3, "x1", temp_x1, "x2", temp_x2, "x3",
            temp_x3);
    fprintf(fptr,
...
{                                                                           \
   ...
   aflcrash(cond, postflag);                                                   \
    ...
    if (f == 0 && postflag == 1) {                                             \
      \ 
        fprintf(                                                               \
          fptr, "Post : %s : %lld, %s : %lld, %s : %lld, %s : %lld, %s : %lld, %s : %lld\n", \ 
 "d1",                                                                         \
    ...
    if (choices > 10000) {
      ...
      if ((x1 > 0)) {
        ...
        while ((x1 > 0) && k--) {
          ...
          loopcount++;
          loopcheck(fptr, vars, temp_x1, temp_x2, temp_x3, d1, d2, d3, x1, x2,
                    x3);
        }
      } else {
        // post-check program
