...
void precheck(FILE *fptr, char *buff, long long int a, long long int c,
              long long int m, long long int j, long long int k) {
  int f = preflag;
...
void loopcheck(FILE *fptr, char *buff, long long int temp_a,
               long long int temp_c, long long int temp_m, long long int temp_j,
               long long int temp_k, long long int a, long long int c,
               long long int m, long long int j, long long int k) {
  int f = loopflag;
    ...
    if (choices > 10000) {
      ...
      if ((k < c)) {
        ...
        while ((k < c) && unroll--) {
          ...
          loopcount++;
          loopcheck(fptr, vars, temp_a, temp_c, temp_m, temp_j, temp_k, a, c, m,
                    j, k);
        }
      } else {
        // post-check program
