...
void precheck(FILE *fptr, char *buff, long long int n, long long int v1,
...
void loopcheck(FILE *fptr, char *buff, long long int temp_n,
               long long int temp_y, long long int temp_x, long long int n,
  ...
  if (f == 0 && loopflag == 1) {
    fprintf(fptr,
            ...
            "%lld, %s : %lld\n",
            "n", temp_n, "v1", v1, "v2", v2, "v3", v3, "x", temp_x, "y",
            temp_y);
    fprintf(fptr,
