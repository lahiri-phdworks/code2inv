...
void precheck(FILE *fptr, char *buff, long long int i, long long int n,
              long long int sn, long long int v1, long long int v2,
              long long int v3) {
  int f = preflag;
...
void loopcheck(FILE *fptr, char *buff, long long int temp_i,
               long long int temp_n, long long int temp_sn, long long int i,
               long long int n, long long int sn, long long int v1,
  ...
  if (f == 0 && loopflag == 1) {
    fprintf(fptr,
            ...
            "%lld, %s : %lld\n",
            "i", temp_i, "n", temp_n, "sn", temp_sn, "v1", v1, "v2", v2, "v3",
            v3);
    fprintf(fptr,
