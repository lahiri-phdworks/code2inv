...
void loopcheck(FILE *fptr, char *buff, long long int temp_x, long long int temp_y, long long int temp_w,
               long long int x, long long int y, long long int w)
{
    int f = loopflag;
