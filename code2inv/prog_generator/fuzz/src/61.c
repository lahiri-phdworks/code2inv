...
void precheck(FILE *fptr, char *buff, long long int c, long long int n,
...
void loopcheck(FILE *fptr, char *buff, long long int temp_c,
               long long int temp_n, long long int c, long long int n,
               long long int v1, long long int v2, long long int v3) {
  int f = loopflag;
  ...
  for (;;) {
    ...
    if (choices > 10000) {
      ...
      if ((choices > 1500)) {
        ...
        if ((c == n)) {
          postcount++;
          postcheck(fptr, vars, ((n <= -1)), c, n, v1, v2, v3)
        }
      }
    }
